...
/**
 * Pattern: Changing a branch condition. Example: if(a == b) → if(a == b && c !=
 * 0). Description: This pattern modifies a branch condition in conditional
 * statements or in ternary operators. Patches in this pattern often just add a
 * term to a predicate or remove a term from a predicate.
 *
 * @author kui.liu
 *
 */
public abstract class ChangeCondition extends FixTemplate {
    ...
    /**
     * Map<ITree, Integer>: ITree - Predicate Exp AST, Integer - distance to
     * suspicious stmt.
     *
     * @return
     */
...
//			}
    ...
    /**
     * Map<ITree, Integer>: ITree - predicate exp ast, Integer - start or end
     * pos of the key value.
     *
     * @param suspStmtAst
     * @return
     */
