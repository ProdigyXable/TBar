...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        fixBug(bugDataPath, defects4jHome, bugId, args[3], args[4], args[5]);
        System.exit(0);
    }

    public static void fixBug(String bugDataPath, String defects4jHome, String bugIdStr, String proflMethod, String proflTest, String proflFailing) {
        ...
        System.out.println("Repair process completed");
    }
