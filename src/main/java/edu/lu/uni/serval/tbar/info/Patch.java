...
public class Patch {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Patch) {
            Patch p = (Patch) obj;
            if (!buggyFileName.equals(p.buggyFileName)) {
                return false;
            }
            if (!buggyCodeStr.equals(p.buggyCodeStr)) {
                return false;
            }
            if (buggyCodeStartPos != p.buggyCodeStartPos) {
                return false;
            }
            if (buggyCodeEndPos != p.buggyCodeEndPos) {
                return false;
            }
            if (!fixedCodeStr1.equals(p.fixedCodeStr1)) {
                return false;
            }
            if (fixedCodeStr2 == null) {
                if (p.fixedCodeStr2 != null) {
                    return false;
                }
            } else if (!fixedCodeStr2.equals(p.fixedCodeStr2)) {
                return false;
            }
            return true;
        } else {
