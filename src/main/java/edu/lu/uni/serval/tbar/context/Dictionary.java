...
public class Dictionary {
    ...
    /**
     * Find the class name and path of the data type of a field in the current
    ...
    /**
     * Find all constructors of which class instance is created in the current
     * class.
     *
     * @param currentClassPath
    ...
    /**
     * Find all methods that can be accessed by the current class, including the
     * protected methods and public ones of its super class.
     *
     * @param currentClassPath
     * @return
     */
    public List<Method> findAllAvailableMethodsOfThisClass(String currentClassPath, boolean needsPrivateMethods, boolean needsProtectedMethods) {
        ...
        if (!needsProtectedMethods) {
            needsPrivateMethods = false;
        }
