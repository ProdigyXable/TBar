...
public class StatementInserter extends FixTemplate {
    ...
    public void generatePatches() {
        ...
        if (Checker.isBreakStatement(suspCodeTree.getType()) || Checker.isContinueStatement(suspCodeTree.getType())) {
            return;
        }
